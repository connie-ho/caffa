 ...
 */ function N(t) {
    ...
    if (I.logLevel <= a.DEBUG) {
        var r = e.map(k);
        I.debug.apply(I, b([ "Firestore (8.3.3): " + t ], r));
    }
}
...
function S(t) {
    ...
    if (I.logLevel <= a.ERROR) {
        var r = e.map(k);
        I.error.apply(I, b([ "Firestore (8.3.3): " + t ], r));
    }
}
...
function D(t) {
    ...
    if (I.logLevel <= a.WARN) {
        var r = e.map(k);
        I.warn.apply(I, b([ "Firestore (8.3.3): " + t ], r));
    }
}
 ...
 */ function Wt(t) {
    ...
    if (null === e.p) {
        ...
        n.isKeyField() || e.p.push(new Ft(n)), e.p.push(new Ft(Q.keyField(), "asc" /* ASCENDING */)); else {
        ...
        return void 0 === t && void 0 === e || !(!t || !e) && F(t, e, (function(t, e) {
            return function(t, e) {
                return t.field.isEqual(e.field) && function(t, e) {
                    return t instanceof he && e instanceof he || t instanceof fe && e instanceof fe ? F(t.elements, e.elements, ot) : t instanceof pe && e instanceof pe ? ot(t.A, e.A) : t instanceof ce && e instanceof ce;
...
function kn(t) {
    return t ? void 0 !== t.unaryFilter ? [ Mn(t) ] : void 0 !== t.fieldFilter ? [ Fn(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((function(t) {
        return kn(t);
    })).reduce((function(t, e) {
        return t.concat(e);
    })) : R() : [];
    ...
    return m(e, t), e.prototype.wr = function(t) {
        ...
        var e = function(t, e) {
            ...
            n = new nn([], o, i, null); else {
                ...
                e.filter;
                var h = e.filter;
                h.targetId, r = h.count || 0, i = new Fe(r), o = h.targetId, n = new rn(o, i);
            }
            return n;
        ...
        return w(this, (function(h) {
            switch (h.label) {
              ...
              case 1:
                ...
                a = o.applyChanges(s, 
                /* updateLimboDocuments= */ t.isPrimaryClient, u), Ji(t, n, a.To), c = new Vi(e, n, o), 
 ...
 */ function to(t) {
    for (;t.So.size > 0 && t.Do.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.Co.set(r, new Fi(n)), t.Do = t.Do.insert(n, r), zr(t.remoteStore, new zn(Ht(Bt(n.path)), r, 2 /* LimboResolution */ , _.o));
    }
}
...
var oo = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        return g(this, void 0, void 0, (function() {
            return w(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.R = Fr(t.databaseInfo.databaseId), this.sharedClientState = this.Bo(t), 
    ...
    return t.prototype.initialize = function(t, e) {
        ...
        var e, n = Fr(t.databaseInfo.databaseId), r = (e = t.databaseInfo, new Pr(e));
 ...
 */ var Bo = /** @class */ function() {
    ...
    function t(t, e) {
        ...
        t instanceof No ? (this._databaseId = t, this._credentials = new ko) : (this._app = t, 
 ...
 */ function Wo(t, e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = P.u()), Oo("doc", "path", e), t instanceof jo) return Fo(n = G.fromString.apply(G, b([ e ], r))), 
    new Go(t, 
    /* converter= */ null, new rt(n));
    if (!(t instanceof Go || t instanceof Qo)) throw new T(E.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    return Fo(n = t._path.child(G.fromString.apply(G, b([ e ], r)))), new Go(t.firestore, t instanceof Qo ? t._converter : null, new rt(n));
}
 ...
 * classes.
 */ function ds(t) {
    var e = t._freezeSettings(), n = Fr(t._databaseId);
 ...
 */ var Fs = /** @class */ function() {
    ...
    /** @hideconstructor */
    function t(t, e, n, r) {
        this._firestore = t, this._userDataWriter = e, this._snapshot = r, this.metadata = new Fs(r.hasPendingWrites, r.fromCache), 
        this.query = n;
    }
    ...
    t.prototype.forEach = function(t, e) {
        ...
        this._snapshot.docs.forEach((function(r) {
            t.call(e, new Us(n._firestore, n._userDataWriter, r.key, r, new Fs(n._snapshot.mutatedKeys.has(r.key), n._snapshot.fromCache), n.query._converter));
        }));
    }, 
    /**
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((function(e) {
                    var r = new Us(t._firestore, t._userDataWriter, e.doc.key, e.doc, new Fs(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query._converter);
                    return e.doc, {
                        type: "added",
                        doc: r,
                        oldIndex: -1,
            ...
            return t._snapshot.docChanges.filter((function(t) {
                ...
                var n = new Us(t._firestore, t._userDataWriter, e.doc.key, e.doc, new Fs(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query._converter), i = -1, o = -1;
 ...
 */
    ...
    return m(e, t), e.prototype._apply = function(t) {
        return new Ko(t.firestore, t._converter, Yt(t._query, this.Gc, this.zc));
    }, e;
 ...
 */ function cu(t, e, n) {
    ...
    return new Ms(t, i, e._key, r, new Fs(n.hasPendingWrites, n.fromCache), e._converter);
}
 ...
 */ var hu = /** @class */ function(t) {
     ...
     */    return m(e, t), e.prototype.get = function(e) {
        ...
        return t.prototype.get.call(this, e).then((function(t) {
            return new Ms(n._firestore, i, r._key, t._document, new Fs(
            /* hasPendingWrites= */ !1, 
 ...
 */ var wu = /** @class */ function() {
    ...
    return t.prototype.get = function(t) {
        ...
        return this._delegate.get(n).then((function(t) {
            return new Nu(e._firestore, new Ms(e._firestore._delegate, e._userDataWriter, t._key, t._document, t.metadata, n._converter));
        }));
    }, t.prototype.set = function(t, e, n) {
        var r = Lu(t);
 ...
 */    }, t.prototype.onSnapshot = function() {
        ...
        var r = Iu(e), i = Au(e, (function(e) {
            return new Nu(t.firestore, new Ms(t.firestore._delegate, t._userDataWriter, e._key, e._document, e.metadata, t._delegate._converter));
        }));
        ...
        return ("cache" === (null == t ? void 0 : t.source) ? function(t) {
            ...
            return function(t, e) {
                ...
                return new Ms(e, r, t._key, n, new Fs(null !== n && n.hasLocalMutations, 
            ...
            return new Nu(e.firestore, new Ms(e.firestore._delegate, e._userDataWriter, t._key, t._document, t.metadata, e._delegate._converter));
        }));
    }, t.prototype.withConverter = function(e) {
...
export { vu as $, wu as B, Nu as G, Du as H, gu as L, Eu as Q, Cu as X, Ru as Y, Zo as _, M as a, Pu as e, yu as k, ts as m, Vu as n, bu as q, Fu as s, Ou as t, ss as v, du as x, Su as z };
//# sourceMappingURL=prebuilt-5afb01f7-e1acde42.js.map
