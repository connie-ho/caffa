...
('Superdark', 'Body, balance and a dazzling dark cocoa-laced finish. 
...
('Bold', 'Edgy on the one hand, seductively smooth on the other. 
...
('Classic', 'A coffee insider’s favourite. Elegant acidity highlights a nuanced, medium-bodied cup.', 'Guatemala', 'Medium', 'Ethical Bean Coffee', 'Medium to High', 'Arabica', 'https://cdn.shopify.com/s/files/1/0059/2772/products/decaf-ground_600x600.jpg?v=1594355882'), 

('Exotic', 'Ephemeral aromatics laced with fruity, floral innuendo. 
...
('Mellow', 'Medium body, nutty aroma and a sweet brightness.
...
('Dark Roast, Fine Grind', 'Perfectly balanced, medium-bodied coffee with a smooth finish', 'Colombia', 'Dark','Tim Hortons','low', 'Arabica', 'https://images-na.ssl-images-amazon.com/images/I/81ms6TpLMEL._AC_SL1500_.jpg'),
...
('Gold Origins Sumatra Instant','NESCAFÉ Gold origins Colombia coffee (95 g) is a medium-bodied profile with a juicy and fruity flavour','Colombia','Dark','Nescafe','Low','Arabica','https://images-na.ssl-images-amazon.com/images/I/81EALMbmyOL._AC_SL1500_.jpg'),
...
('Miguel Angel Ruiz Pacas', 'Miguel was one of the first producers we ever bought from when we first started roasting. He grows both Parainema and Pacas varieties on his farm, located in La Leona, a micro region of Santa Barbara. The Pacas variety is a natural spontaneous mutation of the Bourbon variety. It is very hardy, can thrive in many different environments and produces good quality in the cup. Miguels coffees are always intense and unique, which make this really exciting!', 'Honduras','Medium','Monogram Coffee','Low','Arabica', 'https://cdn.shopify.com/s/files/1/0702/0489/products/MIGUEL_Filter_pacas_352x576.png?v=1614817745'),

('Alasitas Java Mocha',
  'The Java variety originates from Ethiopia and has a wonderful and complex flavour profile that is super unique to its variety. The Rodriguez family produces beautiful and delicious Javas and we are so happy to have these coffees in our collection.',
  'Bolivia',
  'Dark',
  'Monogram Coffee',
  'Medium-High',
...
('Mambo #5',
 ...
 ('Epic Espresso',
  ...
  'Medium',
  'Arabica',
  'https://cdn.shopify.com/s/files/1/0266/0247/1487/products/Longitude123_2021_PDP_2048x2048.png?v=1618870828'),
  ('Balzacs Blend',
  'Based on Honoré de Balzac’s own blend. Bold, rounded and generous — a gutsy cup.',
  'Sumatra',
  'Dark',
  'Balzac',
  'Medium-High',
  'Arabica',
  'https://dynamic.indigoimages.ca/v1/gifts/balzacs-blend-whole-bean-coffee/628614000102/1.jpg?scaleup=true&width=614&maxheight=614'),
  ('Espresso Cremossa',
  'Cremossa blend has a very refined acidity and a full, intensive and powerful aroma. Ideal coffee for espresso, latte macchiato, cappuccino and dark café au lait.',
  'Columbia',
  'Dark',
  'Gaia Coffee',
  'Medium-High',
  'Arabica',
  '//cdn.shopify.com/s/files/1/2659/8394/products/unnamed.jpg?v=1578501706'),
  ('Phil & Sebastian R1 Standard Espresso Roast',
  'Sweet coffees that are approachable, chocolatey, nutty, and with lower acidity.',
  'Colombia',
  'Medium',
  'Phil & Sebastian Coffee Roasters',
  'Low',
  'Arabica',
  'https://cdn.shopify.com/s/files/1/2404/0687/products/the-standard_-18.11.08_1200x_84d04ee0-4f0f-4e51-8001-60eff87e45fb_1800x1800.jpg?v=1584558834'),
  ('Lavazza Super Crema Espresso Whole Beans 1 kg',
  'A velvety-cream coffee blend with aromas of honey and almonds, for a sweet, creamy espresso.',
  'Brazil',
  'Medium',
  'Lavazza',
  'Medium',
  'Arabica',
  'https://cdn.shopify.com/s/files/1/0131/2381/3434/products/lavazza-super-crema-new.jpg?v=1569568209'),
  ('Equal Exchange, Organic, Coffee, Love Buzz, Whole Bean , 12 oz (340 g)',
  ...
  'Medium',
  'Arabica',
  'https://s3.images-iherb.com/equ/equ40614/y/0.jpg'),
  ('Planet Bean Morning Glory Whole Bean Coffee 12oz',
  'This is a medium blend, with just a touch of the darkest beans to liven things up. Great for getting going in the mornings!',
  'Argentina',
  'Dark',
  'Planet Bean Coffee',
  'Medium',
  'Arabica',
  'https://cdn.shopify.com/s/files/1/0131/2381/3434/products/planet-bean-morning-glory.jpg?v=1569502803'),
  ('Bulletproof Original Whole Bean Reg. Coffee 340g',
  'Medium roasted in small batches enhancing the naturally occurring antioxidant capacity and flavor Distinct notes of cinnamon, plum, and orange with a cocoa hazelnut finish.',
  'Brazil',
  'Medium',
  'Bulletproof',
  'Medium',
  'Arabica',
  'https://cdn.shopify.com/s/files/1/0525/1461/9579/products/Bulletproof_Clean_Coffee_The_Original_Whole_Bean_340g_400x.jpg?v=1613243133'),
  ('Lavazza GRAN CREMA Espresso Beans 2.2 Lbs (1000gr)',
  'A slow roasted blend of beans, Espresso Gran Crema produces aromatic notes of baked goods with a lingering crema and round flavour.',
  'Colombia',
  'Dark',
  'Lavazza',
  'High',
  'Arabica',
  'https://www.creativecoffee.ca/images/products/phpMgwL72.jpg'),
  ('Lavazza FAIRTRADE TIERRA Espresso Beans 2.2 Lbs (1000 gr)',
  ' Lavazza Tierra Finest blend of 100% Arabica coffees with an intense taste and hints of chocolate, sustainably grown in Rainforest Alliance Certified coffee farms. Imported from Italy.',
  'Colombia',
  'Dark',
  'Lavazza',
  'Medium-High',
  'Arabica',
  'https://www.creativecoffee.ca/images/products/phpJl0Dk9.jpg')